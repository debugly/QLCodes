...
@interface EZCarouseImageView : UICollectionView
...
//点击代理；
@property (nonatomic, weak) id<EZCarouseImageViewDelegate>carouseDelegate;
...
/**
 block回调点击事件，通过delegate也可以；
 */
- (void)didClickedEZCarouseImageView:(void(^)(NSUInteger idx))block;
